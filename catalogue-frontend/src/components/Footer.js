      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold uppercase tracking-wider text-orange-200">
              Shop
            </h3>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4 pt-2">
              <a href="#" className="text-xl hover:text-orange-300 transition">
              ...
              <a
                href="https://www.instagram.com/ckaofficial.id/"
