          ...
          <div className="flex flex-col lg:flex-row gap-10 justify-center items-center">
            <div className="flex flex-col lg:flex-row">
              <div className="flex flex-col items-center text-center rounded-lg shadow-lg w-[30vh] h-[35vh] bg-white gap-3 py-10 px-8">
                <div className="flex items-center justify-center rounded-[50%] w-[2em] h-[2em] bg-gray-200 text-2xl text-orange-800">
                  <i class="fas fa-map-marker-alt"></i>
                </div>
                <div>
                  <h3 className="font-bold mb-2">Visit Us</h3>
                  <p>
                    We are committed to ensuring the welfare and prosperity of
